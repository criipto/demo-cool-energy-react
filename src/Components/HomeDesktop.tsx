...
function Home() {
  ...
  const newsContent = (
    <p className="font-normal text-base pb-8">
      Lorem ipsum dolor sit amet consectetur. Nam aenean cursus placerat
      habitasse duis massa id sagittis curabitur. Dapibus sed auctor sed lectus
      erat nec quam.
    </p>
  );
      ...
      {!claims && (
        <div className="flex mb-4 justify-center align-center content-start">
          {newsHeadings.map((heading) => (
            <ul className="flex flex-row items-start justify-center align-center content-start h-[284px]">
